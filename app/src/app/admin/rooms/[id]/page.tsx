...
export default function AdminRoomDetailPage() {
  ...
  return (
    <AppShell role="admin" userName="Admin Cruz" pageTitle="Room Details">
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
          {[
            ...
            },
            {
              ...
              value: String(ROOM_SCHEDULE.length),
              accent: "#8b5cf6",
            },
          ].map((s) => (
            <div
              key={s.label}
              className="card card-body py-3 px-4 animate-fade-in"
            >
              <p
        ...
        {/* ── Tabs ── */}
        <div
          className="flex gap-0.5 mb-4 p-1 rounded-lg w-fit"
        ...
        {activeTab === "details" && (
          <div className="card card-body animate-fade-in">
            <div className="flex items-center justify-between mb-5">
              ...
              {isDirty && (
                <span className="badge badge-yellow animate-fade-in">
                  Unsaved changes
                </span>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
              ...
              <div className="form-group">
                ...
                {errors.room_number ? (
                  ...
                  <span className="form-hint">
                    Official room identifier (e.g., CS-101)
                  </span>
                )}
              </div>
              ...
              <div className="form-group">
                ...
                {errors.capacity ? (
                  ...
                  <span className="form-hint">
                    Strictly enforced during request approval.
                  </span>
                )}
              </div>
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  style={
                    errors.type_id ? { borderColor: "var(--color-error)" } : {}
                  }
                >
                ...
                {errors.type_id && (
                  <span className="form-error">{errors.type_id}</span>
                )}
              </div>
            </div>
            ...
            <div className="form-group mb-6">
              ...
              <span className="form-hint">
                Setting to Maintenance prevents new room requests.
              </span>
            </div>
            ...
            <div className="card card-body mb-4">
              ...
              <div className="flex gap-2 flex-wrap">
                {[
                  ...
                  const slots = ROOM_SCHEDULE.filter(
                  ...
                  return (
                    <div
                      key={day}
                      className="flex-1 min-w-25 rounded-lg p-3"
                      style={{
                        backgroundColor:
                          slots.length > 0
                            ? color + "14"
                            : "var(--color-surface-2)",
                        border: `1.5px solid ${slots.length > 0 ? color + "40" : "var(--color-border)"}`,
                      }}
                    >
                      <p
                        className="text-xs font-semibold mb-2"
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="badge badge-gray">
                    {ROOM_SCHEDULE.filter((s) => !s.is_active).length} released
                  </span>
                </div>
              </div>
                      ...
                      <tr key={slot.id}>
                        ...
                        <td>
                          <span
                            ...
                            style={{
                              backgroundColor:
                                DAY_COLORS[slot.day_of_week] + "18",
                              color: DAY_COLORS[slot.day_of_week],
                            }}
                          >
                            {slot.day_of_week}
                          </span>
              ...
              <div className="flex items-start gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-sm font-semibold mb-1">
                    {ROOM.is_available ? "Disable" : "Enable"} Room{" "}
                    {ROOM.room_number}?
                  </h3>
                  <p
                    className="text-xs"
                  ...
                  {activeBookings > 0 && ROOM.is_available && (
                    ...
                    >
                      ⚠ This room has {activeBookings} active booking
                      {activeBookings > 1 ? "s" : ""}.
                    </p>
                  )}
                </div>
