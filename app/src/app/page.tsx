  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(34,160,80,.10) 0%, transparent 70%)",
        }}
      />
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(34,160,80,.07) 0%, transparent 70%)",
        }}
      />
      <div
...
const TEST_ACCOUNTS: Record<string, { role: Role; password: string }> = {
  "testingadmin@cvsu.edu.ph": { role: "admin", password: "1234" },
  "testingstudent@cvsu.edu.ph": { role: "student", password: "1234" },
  "testingprof@cvsu.edu.ph": { role: "instructor", password: "1234" },
};
